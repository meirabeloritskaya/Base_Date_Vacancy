        ...
        with conn.cursor() as cur:
            for vacancy in data:
                ...
                cur.execute('''
                            ...
                            VALUES (%s, %s, %s, %s, %s)
                            ''',
                            (vacancy['employer']['id'], vacancy['name'], vacancy['salary']['from'] if vacancy['salary'] else None, vacancy['salary']['currency'] if vacancy['salary'] else None, vacancy['alternate_url']))
